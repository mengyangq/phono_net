setwd("/Users/mengyang/Documents/github/phono_net/English_MALD/")
library("igraph")
library("qgraph")
library("BSDA")
library('CINNA')
...
nodes <- read.csv("english_phono_nodes.csv",header=T,as.is=T)

all_links <- read.csv("english_phono_links.csv",header=T,as.is=T)

replace_links <- read.csv("english_phono_replace_links.csv",header=T,as.is=T)

delins_links <- read.csv("english_phono_delins_links.csv",header=T,as.is=T)
